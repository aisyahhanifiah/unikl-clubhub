                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ Breadcrumbs::render('admin.user.create') }}</h3>
                            </div>
                        ...
                        <form method="post" action="{{ route('admin.user.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('unikl_id') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="unikl_id" id="input-unikl_id" class="form-control form-control-alternative{{ $errors->has('unikl_id') ? ' is-invalid' : '' }}" placeholder="{{ __('UniKL ID') }}" value="{{ old('unikl_id') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('phone_no') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="phone_no" id="input-phone_no" class="form-control form-control-alternative{{ $errors->has('phone_no') ? ' is-invalid' : '' }}" placeholder="{{ __('Phone No.') }}" value="{{ old('phone_no') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('dob') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="dob" id="input-dob" class="form-control form-control-alternative{{ $errors->has('dob') ? ' is-invalid' : '' }}" placeholder="{{ __('Date of birth') }}" value="" required>
