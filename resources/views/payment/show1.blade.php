...
@section('title', 'Receipt for ' .$club->name.' |')
...
<div class="header pb-8 pt-5 pt-md-8">
	<div class="container-fluid">
		...
		<div class="header-body">
			{{ Breadcrumbs::render('payment.show1', $club->id) }}
		</div>
	</div>
</div>
					...
					<div class="card-header border-0">
						<div class="row align-items-center">
							...
							<div class="col-6 col-sm-3 text-right text-sm-left">
								<h3 class="mb-0">RM{{ number_format($userclub->paid_out, 2)}}</h3>
							</div>
                    ...
                    <div class="card-body px-lg-6">
                    	<div class="row pb-5">
                    		<div class="col-7 px-5">
                    			...
                    			<p class="text-md font-weight-bold text-uppercase">{{ Carbon\Carbon::parse($userclub->updated_at)->format('d M Y') }}</p>
                    		</div>
                    		<div class="col-5 px-4">
                    			<span class="text-uppercase" style="font-size: 0.75rem;">Time</span>
                    			<p class="text-md font-weight-bold text-uppercase">{{ Carbon\Carbon::parse($userclub->updated_at)->format('h:i A') }}</p>
                    	...
                    	<div class="row ">
                    		<div class="col-7 px-5">
                    			...
                    			<p class="text-md font-weight-bold text-uppercase">#{{$userclub->stripe_charge_id}}</p>

                    		</div>
                    		<div class="col-5 px-4">
                    			<span class="text-uppercase" style="font-size: 0.75rem;">Payment Method</span>
                    			<p class="text-md font-weight-bold text-uppercase">{{ Auth::user()->stripe_type }} xxxx-xxxx-xxxx-{{ Auth::user()->stripe_card }}</p>
                    ...
                    <div class="card-body px-lg-10">
                    	...
                    	<div class="row py-3 mx-1 bg-primary text-white align-items-center rounded align-items-center">
                    		<div class="col-md-8 px-5">
                    			...
                    			<p class="text-md pb-0 font-weight-bold text-uppercase">{{ $club->name }}</p>
                    		</div>
                    		<div class="col-md-4 px-5">
                    			{{-- <span class="text-uppercase" style="font-size: 0.75rem;">Transaction ID</span> --}}
                    			<p class="text-md font-weight-bold text-uppercase text-right">RM{{ number_format($club->fees, 2) }}</p>
                    	...
                    	<div class="row py-3">
                    		...
                    		<div class="col-11 px-2 text-right">
                    			<span class="text-uppercase" style="font-size: 0.75rem;">Total </span><span class="text-lg font-weight-bold text-uppercase">RM{{ number_format($userclub->paid_out, 2)}}</span>
                    	...
                    	<div class="row">
                    		...
                    		<div class="col-12 px-2">
                    			<div class="text-center">
                    				<a href="{{ route('print.receipt.club', $userclub->id) }}" class="btn btn-success">{{ __('Print Receipt') }}</a>
                    			</div>
