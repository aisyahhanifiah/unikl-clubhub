<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('myclub.index') }}">
                        <i class="ni ni-app" style="color: #FBD04F ;"></i> {{ __('My Clubs') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('event.index') }}">
                        <i class="ni ni-notification-70 text-primary"></i> {{ __('Events') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-collection text-default"></i> {{ __('Attendance') }}
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('club.index') }}">
                        <i class="ni ni-money-coins text-success"></i> {{ __('Payment') }} (soon)
                    </a>
                </li>
                {{-- <li class="nav-item">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('committee.club.index') }}">
                        <i class="ni ni-settings-gear-65 text-primary"></i>Manage Clubs
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.event.index') }}">
                        <i class="ni ni-settings-gear-65 text-primary"></i> {{ __('Manage Events') }} (soon)
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.user.index') }}">
                        <i class="ni ni-settings-gear-65 text-primary"></i> {{ __('Manage Meetings') }} (soon)
                    </a>
                </li>
